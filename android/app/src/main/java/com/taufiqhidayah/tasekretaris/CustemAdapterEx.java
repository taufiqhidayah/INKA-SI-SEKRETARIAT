...
class CustemAdapterEx extends BaseAdapter {
    ArrayList<Data> data;
    Context context;

    public CustemAdapterEx(DetailSuratExternalActivity detailSuratExternalActivity, ArrayList<Data> data) {
        this.data = data;
        this.context = detailSuratExternalActivity;
    }
...
//        TextView tvhrg = (TextView) view.findViewById(R.id.tvHarga);
        ...
        tvjumlh2.setText("" + data.get(position).getTgl_masuk());
